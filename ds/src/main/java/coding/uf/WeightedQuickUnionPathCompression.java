...
/**
 * Implementation of Weighted Quick Union Algorithm, along with path compression find operation
 * takes very very very nearly but not quite 1 (amortized) union operation takes very very very
 * nearly but not quite 1 (amortized)
 *
 * @author Harshad Shrishrimal
 */
public final class WeightedQuickUnionPathCompression extends UF {
