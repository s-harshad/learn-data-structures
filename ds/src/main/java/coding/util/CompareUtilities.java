...
public final class CompareUtilities {
   ...
   * @return {@code true} if element represented by {@code firstIndex} is less than {@code
   *     secondIndex}; {@code false} otherwise.
   */
   ...
   * @return {@code true} if element represented by {@code firstIndex} is less or equal to {@code
   *     secondIndex}; {@code false} otherwise.
   */
  public static final <T> boolean lessOrEqual(
      T[] array, Comparator<T> comparator, int firstIndex, int secondIndex) {
   ...
   *     secondIndex}; {@code false} otherwise.
   */
  public static final <T> boolean less(
      T[] array, Comparator<T> comparator, int firstIndex, int secondIndex) {
   ...
   */
  public static final <T extends Comparable<T>> void merge(
      Comparable[] array, int lo, int mid, int hi) {
