...
/**
 * Implementation of Insertion Sort algorithm. To Sort a randomly-ordered array with distinct keys,
 * Insertion sort uses ~ (1/4)N*N compares and ~ (1/4)N*N exchanges on average
 *
 * <p>It is not suitable for sorting large arbitrary arrays. More precisely, the number of exchanges
 * is exactly equal to the number of inversions. So, for example, it sorts a partially-sorted array
 * in linear time.
 *
