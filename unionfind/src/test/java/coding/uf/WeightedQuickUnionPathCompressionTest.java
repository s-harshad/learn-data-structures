...
public class WeightedQuickUnionPathCompressionTest {
    ...
    @Test
    @DisplayName("WeightedQuickUnionPathCompression number of components should equal number of elements, INITIALLY")
    void count_1() {
    ...
    @Test
    @DisplayName("WeightedQuickUnionPathCompression one call to union, should decrease connected components by 1")
    void count_2() {
        UF uf = new WeightedQuickUnionPathCompression(10);
        uf.union(4, 3);
    ...
    @Test
    @DisplayName("WeightedQuickUnionPathCompression calling union with the same parameters, should only decrease the count multiple times")
    void count_3() {
        UF uf = new WeightedQuickUnionPathCompression(10);
        uf.union(4, 3);
        Assertions.assertEquals(9, uf.count());
