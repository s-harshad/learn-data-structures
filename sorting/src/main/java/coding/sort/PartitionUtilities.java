...
final class PartitionUtilities {
  ...
  /**
   * Partition the sub-array array[startIndex ..... endIndex], so that array[startIndex ..... lt -
   * 1] < array[lt ..... gt] < array[gt + 1 ..... endIndex] All elements between [lt ..... gt] are
   * EQUAL
   *
   ...
   */
  static final <T extends Comparable<T>> int[] partitionDuplicateEntriesInArray(
      T[] array, int startIndex, int endIndex) {
  ...
  /**
   * Partition the sub array array[startIndex ..... endIndex], so that array[startIndex .....
   * rightIndex - 1] <= array[rightIndex] < array[rightIndex + 1 ..... endIndex]
   *
   * @param array array to be partitioned
   * @param startIndex start index for the array
   * @param endIndex end index for the array
