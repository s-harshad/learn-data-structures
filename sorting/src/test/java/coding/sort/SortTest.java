...
public class SortTest {
  ...
  void LSDSort_Strings_Test() {
    String[] input =
        new String[] {
          "bpeg", "xsdx", "mhjs", "nzks", "gxwy", "pbqu", "ikfn", "hxwt", "kzmc", "oqpv", "xive",
          "xkov", "jiia", "jkgq", "ipcz", "kmtj", "hlrm", "godj", "vklm", "ajyg", "uyxh", "ytrl",
          "tkdo", "jwxq", "awka"
        };
    String[] expectedOutput =
        new String[] {
          "ajyg", "awka", "bpeg", "godj", "gxwy", "hlrm", "hxwt", "ikfn", "ipcz", "jiia", "jkgq",
          "jwxq", "kmtj", "kzmc", "mhjs", "nzks", "oqpv", "pbqu", "tkdo", "uyxh", "vklm", "xive",
          "xkov", "xsdx", "ytrl"
        };
    LSDSort.sort(input);
